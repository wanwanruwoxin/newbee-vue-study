<template>
  <DialogAddHotGood ref='addGood' :reload="getIndexConfig" :type="type" :configType="configType"></DialogAddHotGood>
...
import DialogAddHotGood from "../components/DialogAddHotGood.vue";
...
export default {
  ...
  setup() {
    ...
    const handleAdd = () => {
      state.type = 'add'
      addGood.value.open()
      // console.log(addGood.value.visible)
    }
